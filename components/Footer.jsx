            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="lg:col-span-2">
                        <h3 className="heading-md font-semibold mb-3">
                        ...
                        <div className="flex gap-3">
                            ...
                            {clinicData.social.instagram && (
                                <a
                                    ...
                                    target="_blank"
                                    className="w-10 h-10 bg-white/10 hover:bg-red-400 rounded-full flex items-center justify-center transition"
                                >
                            ...
                            <a
                                ...
                                target="_blank"
                                className="w-10 h-10 bg-white/10 hover:bg-green-600 rounded-full flex items-center justify-center transition"
                            >
